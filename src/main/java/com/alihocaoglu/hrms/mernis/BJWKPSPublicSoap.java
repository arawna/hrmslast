...
public class BJWKPSPublicSoap
{
    ...
    public BJWKPSPublicSoap(){}

    public BJWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BJWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BJWExtendedSoapSerializationEnvelope envelope= new BJWExtendedSoapSerializationEnvelope(BJWExtendedSoapSerializationEnvelope.VER11);
